...
# one fixture from each of 16 leagues, 10 flagged value bets and 6 where model and market agree
PREDICTIONS_SAMPLE = [("SK Sturm Graz", "LASK Linz"), ("FC Nordsjaelland", "AGF Aarhus"), ("Man Utd", "Man City"),
                      ("Sheff Utd", "Wolverhampton"), ("Benfica", "Gil Vicente"), ("Levante", "Barcelona"),
                      ("Lecce", "Monza"), ("Djurgarden", "GAIS"), ("Motherwell", "Aberdeen"), ("Lille", "Troyes"),
                      ("Club Brugge", "Antwerp"), ("Hajduk Split", "Slaven Belupo"), ("Legia Warsaw", "Widzew Lodz"),
                      ("FCSB", "Petrolul Ploiesti"), ("Lucerne", "Basel"), ("RB Leipzig", "Hamburg")]
...
def epl_current_ratings():
    """Current ratings for every team in this Premier League season, on all four metrics.

    Taken from the tc_scraper dashboard's Team ratings tab (dashboards/current_ratings.csv, 19-game window,
    the same as the live model). Promoted teams have no raw/nr rating until they have 10 home and 10 away
    Premier League matches.
    """
    cr = pd.read_csv(TC / "dashboards" / "current_ratings.csv")
    cr = cr[(cr["League"] == "EnglandPremierLeague") & cr["in_current_season"]]
    return cr[["Team", "metric", "home_corner_attack_rating", "home_corner_defense_rating",
...
def predictions_sample():
    ...
    return pr[["Date", "League", "Home", "Away", "adjsup", "predicted_home_corners", "predicted_away_corners",
               "predicted_total", "predicted_supremacy", "corner_total", "corner_supremacy", "diff_total", "diff_sup",
               "Corner Handicap",
